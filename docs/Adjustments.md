...
**amount** | **Number** | For fixed-amount adjustments, an amount to be discounted or surcharged. | [optional] 
...
**percentage** | **Number** | For percentage-based adjustments, the percentage amount to be discounted or surcharged. | [optional] 
