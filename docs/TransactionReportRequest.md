...
------------ | ------------- | ------------- | -------------
**from** | **Date** | The date and time of transactions from. | 
**merchantid** | **Number** | The merchant id of the transactions to review. | 
**until** | **Date** | The date and time of transactions until. | 
