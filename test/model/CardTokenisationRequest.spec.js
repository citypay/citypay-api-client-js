...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.CardTokenisationRequest();
  });
  ...
  describe('CardTokenisationRequest', function() {
    it('should create an instance of CardTokenisationRequest', function() {
      // uncomment below and update the code to test CardTokenisationRequest
      //var // instance = new Citypay Api Client.CardTokenisationRequest();
      //expect(instance).to.be.a(Citypay Api Client.CardTokenisationRequest);
    });
