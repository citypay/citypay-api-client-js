...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new citypay_api_client.VoidRequest();
  });
  ...
  describe('VoidRequest', function() {
    it('should create an instance of VoidRequest', function() {
      // uncomment below and update the code to test VoidRequest
      //var instane = new citypay_api_client.VoidRequest();
      //expect(instance).to.be.a(citypay_api_client.VoidRequest);
    });
