...
(function (root, factory) {
    ...
    beforeEach(() => {
        instance = new citypay_api_client.ApiClient.instance.deserialize({
            status: 200,
            body: json
        }, citypay_api_client.ListMerchantsResponse)
    })

    describe('ListMerchantsResponse', function () {

        it('should create an instance of ListMerchantsResponse', function () {
            expect(instance).to.be.a(citypay_api_client.ListMerchantsResponse);
        });

        it('should have the property client_name (base name: "client_name")', function () {
            expect(instance.client_name).to.be("CityPay Demo");
        });
        ...
        it('should have the property merchants (base name: "merchants")', function () {
            expect(instance.merchants.length).to.be(2);
        });
