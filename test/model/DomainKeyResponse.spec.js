...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.DomainKeyResponse();
  });
  ...
  describe('DomainKeyResponse', function() {
    it('should create an instance of DomainKeyResponse', function() {
      // uncomment below and update the code to test DomainKeyResponse
      //var // instance = new Citypay Api Client.DomainKeyResponse();
      //expect(instance).to.be.a(Citypay Api Client.DomainKeyResponse);
    });
