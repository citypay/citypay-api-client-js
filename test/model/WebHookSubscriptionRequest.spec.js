...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.WebHookSubscriptionRequest();
  });
  ...
  describe('WebHookSubscriptionRequest', function() {
    it('should create an instance of WebHookSubscriptionRequest', function() {
      // uncomment below and update the code to test WebHookSubscriptionRequest
      //var // instance = new Citypay Api Client.WebHookSubscriptionRequest();
      //expect(instance).to.be.a(Citypay Api Client.WebHookSubscriptionRequest);
    });
