...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.MerchantBatchReportResponse();
  });
  ...
  describe('MerchantBatchReportResponse', function() {
    it('should create an instance of MerchantBatchReportResponse', function() {
      // uncomment below and update the code to test MerchantBatchReportResponse
      //var // instance = new Citypay Api Client.MerchantBatchReportResponse();
      //expect(instance).to.be.a(Citypay Api Client.MerchantBatchReportResponse);
    });
