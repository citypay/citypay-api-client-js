...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.DirectPostRequest();
  });
  ...
  describe('DirectPostRequest', function() {
    it('should create an instance of DirectPostRequest', function() {
      // uncomment below and update the code to test DirectPostRequest
      //var // instance = new Citypay Api Client.DirectPostRequest();
      //expect(instance).to.be.a(Citypay Api Client.DirectPostRequest);
    });
