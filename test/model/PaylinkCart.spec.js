...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.PaylinkCart();
  });
  ...
  describe('PaylinkCart', function() {
    it('should create an instance of PaylinkCart', function() {
      // uncomment below and update the code to test PaylinkCart
      //var // instance = new Citypay Api Client.PaylinkCart();
      //expect(instance).to.be.a(Citypay Api Client.PaylinkCart);
    });
    ...
    it('should have the property product_description (base name: "product_description")', function() {
      // uncomment below and update the code to test the property product_description
      //var // instance = new Citypay Api Client.PaylinkCart();
      //expect(instance).to.be();
    });

    it('should have the property product_information (base name: "product_information")', function() {
      // uncomment below and update the code to test the property product_information
      //var // instance = new Citypay Api Client.PaylinkCart();
      //expect(instance).to.be();
    });
