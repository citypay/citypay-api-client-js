...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new citypay_api_client.RefundRequest();
  });
  ...
  describe('RefundRequest', function() {
    it('should create an instance of RefundRequest', function() {
      ...
      //var instane = new citypay_api_client.RefundRequest();
      //expect(instance).to.be.a(citypay_api_client.RefundRequest);
    });
    ...
    it('should have the property refund_ref (base name: "refund_ref")', function() {
      // uncomment below and update the code to test the property refund_ref
      //var instane = new citypay_api_client.RefundRequest();
      //expect(instance).to.be();
    });
