...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.DomainKeyRequest();
  });
  ...
  describe('DomainKeyRequest', function() {
    it('should create an instance of DomainKeyRequest', function() {
      // uncomment below and update the code to test DomainKeyRequest
      //var // instance = new Citypay Api Client.DomainKeyRequest();
      //expect(instance).to.be.a(Citypay Api Client.DomainKeyRequest);
    });
