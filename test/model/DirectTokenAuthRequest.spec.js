...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.DirectTokenAuthRequest();
  });
  ...
  describe('DirectTokenAuthRequest', function() {
    it('should create an instance of DirectTokenAuthRequest', function() {
      // uncomment below and update the code to test DirectTokenAuthRequest
      //var // instance = new Citypay Api Client.DirectTokenAuthRequest();
      //expect(instance).to.be.a(Citypay Api Client.DirectTokenAuthRequest);
    });
