...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.PaymentIntentRequestModel();
  });
  ...
  describe('PaymentIntentRequestModel', function() {
    it('should create an instance of PaymentIntentRequestModel', function() {
      // uncomment below and update the code to test PaymentIntentRequestModel
      //var // instance = new Citypay Api Client.PaymentIntentRequestModel();
      //expect(instance).to.be.a(Citypay Api Client.PaymentIntentRequestModel);
    });
