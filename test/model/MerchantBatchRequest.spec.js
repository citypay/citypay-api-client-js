...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.MerchantBatchRequest();
  });
  ...
  describe('MerchantBatchRequest', function() {
    it('should create an instance of MerchantBatchRequest', function() {
      // uncomment below and update the code to test MerchantBatchRequest
      //var // instance = new Citypay Api Client.MerchantBatchRequest();
      //expect(instance).to.be.a(Citypay Api Client.MerchantBatchRequest);
    });
