...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new citypay_api_client.PaResAuthRequest();
  });
  ...
  describe('PaResAuthRequest', function() {
    it('should create an instance of PaResAuthRequest', function() {
      // uncomment below and update the code to test PaResAuthRequest
      //var instane = new citypay_api_client.PaResAuthRequest();
      //expect(instance).to.be.a(citypay_api_client.PaResAuthRequest);
    });
