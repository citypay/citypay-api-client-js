...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.VerificationRequest();
  });
  ...
  describe('VerificationRequest', function() {
    it('should create an instance of VerificationRequest', function() {
      ...
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be.a(Citypay Api Client.VerificationRequest);
    });
    ...
    it('should have the property airline_data (base name: "airline_data")', function() {
      // uncomment below and update the code to test the property airline_data
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cardholder_agreement (base name: "cardholder_agreement")', function() {
      // uncomment below and update the code to test the property cardholder_agreement
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property cp_card_token (base name: "cp_card_token")', function() {
      // uncomment below and update the code to test the property cp_card_token
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property event_management (base name: "event_management")', function() {
      // uncomment below and update the code to test the property event_management
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property external_mpi (base name: "external_mpi")', function() {
      // uncomment below and update the code to test the property external_mpi
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });

    it('should have the property initiation (base name: "initiation")', function() {
      // uncomment below and update the code to test the property initiation
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property mcc6012 (base name: "mcc6012")', function() {
      // uncomment below and update the code to test the property mcc6012
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });

    it('should have the property name_on_card (base name: "name_on_card")', function() {
      // uncomment below and update the code to test the property name_on_card
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });

    it('should have the property payment_intent_id (base name: "payment_intent_id")', function() {
      // uncomment below and update the code to test the property payment_intent_id
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });

    it('should have the property pre_auth (base name: "pre_auth")', function() {
      // uncomment below and update the code to test the property pre_auth
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });
    ...
    it('should have the property threeds_token (base name: "threeds_token")', function() {
      // uncomment below and update the code to test the property threeds_token
      //var // instance = new Citypay Api Client.VerificationRequest();
      //expect(instance).to.be();
    });
