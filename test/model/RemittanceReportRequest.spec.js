...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.RemittanceReportRequest();
  });
  ...
  describe('RemittanceReportRequest', function() {
    it('should create an instance of RemittanceReportRequest', function() {
      // uncomment below and update the code to test RemittanceReportRequest
      //var // instance = new Citypay Api Client.RemittanceReportRequest();
      //expect(instance).to.be.a(Citypay Api Client.RemittanceReportRequest);
    });
