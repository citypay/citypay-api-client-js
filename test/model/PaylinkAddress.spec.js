...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.PaylinkAddress();
  });
  ...
  describe('PaylinkAddress', function() {
    it('should create an instance of PaylinkAddress', function() {
      // uncomment below and update the code to test PaylinkAddress
      //var // instance = new Citypay Api Client.PaylinkAddress();
      //expect(instance).to.be.a(Citypay Api Client.PaylinkAddress);
    });
