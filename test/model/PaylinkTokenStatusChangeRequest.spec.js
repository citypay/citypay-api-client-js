...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.PaylinkTokenStatusChangeRequest();
  });
  ...
  describe('PaylinkTokenStatusChangeRequest', function() {
    it('should create an instance of PaylinkTokenStatusChangeRequest', function() {
      // uncomment below and update the code to test PaylinkTokenStatusChangeRequest
      //var // instance = new Citypay Api Client.PaylinkTokenStatusChangeRequest();
      //expect(instance).to.be.a(Citypay Api Client.PaylinkTokenStatusChangeRequest);
    });
