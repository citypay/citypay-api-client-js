...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.TokenisationResponseModel();
  });
  ...
  describe('TokenisationResponseModel', function() {
    it('should create an instance of TokenisationResponseModel', function() {
      // uncomment below and update the code to test TokenisationResponseModel
      //var // instance = new Citypay Api Client.TokenisationResponseModel();
      //expect(instance).to.be.a(Citypay Api Client.TokenisationResponseModel);
    });
    ...
    it('should have the property sig_id (base name: "sig_id")', function() {
      // uncomment below and update the code to test the property sig_id
      //var // instance = new Citypay Api Client.TokenisationResponseModel();
      //expect(instance).to.be();
    });
