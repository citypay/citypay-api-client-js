...
(function(root, factory) {
  ...
  beforeEach(function() {
    // instance = new Citypay Api Client.Adjustments();
  });
  ...
  describe('Adjustments', function() {
    it('should create an instance of Adjustments', function() {
      // uncomment below and update the code to test Adjustments
      //var // instance = new Citypay Api Client.Adjustments();
      //expect(instance).to.be.a(Citypay Api Client.Adjustments);
    });
