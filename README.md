...
*Citypay Api Client.AuthorisationAndPaymentApi* | [**cardTokenisationRequest**](docs/AuthorisationAndPaymentApi.md#cardTokenisationRequest) | **POST** /v6/tokenise | Card Tokenisation Request
...
*Citypay Api Client.AuthorisationAndPaymentApi* | [**retrievalRequest**](docs/AuthorisationAndPaymentApi.md#retrievalRequest) | **POST** /v6/retrieve | Transaction Retrieval
*Citypay Api Client.AuthorisationAndPaymentApi* | [**verificationRequest**](docs/AuthorisationAndPaymentApi.md#verificationRequest) | **POST** /v6/verify | Verification
...
*Citypay Api Client.OperationalFunctionsApi* | [**registerTempKey**](docs/OperationalFunctionsApi.md#registerTempKey) | **POST** /v6/permissions/register-temp-ip | Register Temp Key
*Citypay Api Client.PaylinkApi* | [**paylinkTokenCloseRequest**](docs/PaylinkApi.md#paylinkTokenCloseRequest) | **PUT** /paylink/{token}/close | Close Paylink Token
...
*Citypay Api Client.PaylinkApi* | [**tokenAttachmentStatus**](docs/PaylinkApi.md#tokenAttachmentStatus) | **GET** /paylink/{token}/attachment-status/{attachment} | Checks an attachment status
*Citypay Api Client.PaylinkApi* | [**tokenCancelRequest**](docs/PaylinkApi.md#tokenCancelRequest) | **PUT** /paylink/{token}/cancel | Cancel a Paylink Token
...
*Citypay Api Client.PaymentIntentApi* | [**createPaymentIntent**](docs/PaymentIntentApi.md#createPaymentIntent) | **POST** /v6/intent/create | Create a Payment Intent
*Citypay Api Client.PaymentIntentApi* | [**getPaymentIntent**](docs/PaymentIntentApi.md#getPaymentIntent) | **POST** /v6/intent/retrieve | Retrieves a Payment Intent
...
*Citypay Api Client.ReportingApi* | [**transactionReportRequest**](docs/ReportingApi.md#transactionReportRequest) | **POST** /v6/transactions | Transaction Report Request
*Citypay Api Client.WebHooks* | [**webHookChannelCreateRequest**](docs/WebHooks.md#webHookChannelCreateRequest) | **POST** /hooks/channel/create | Web Hook Channel Create Request
*Citypay Api Client.WebHooks* | [**webHookChannelDeleteRequest**](docs/WebHooks.md#webHookChannelDeleteRequest) | **POST** /hooks/channel/delete | Web Hook Channel Delete Request
*Citypay Api Client.WebHooks* | [**webHookSubscriptionRequest**](docs/WebHooks.md#webHookSubscriptionRequest) | **POST** /hooks/subscribe | Web Hook Subscription Request
*Citypay Api Client.WebHooks* | [**webHookUnsubscribeRequest**](docs/WebHooks.md#webHookUnsubscribeRequest) | **POST** /hooks/unsubscribe | Web Hook Unsubscribe Request
...
## Documentation for Models
 ...
 - [Citypay Api Client.AdjustmentCondition](docs/AdjustmentCondition.md)
 - [Citypay Api Client.Adjustments](docs/Adjustments.md)
 ...
 - [Citypay Api Client.CardTokenisationRequest](docs/CardTokenisationRequest.md)
 - [Citypay Api Client.CardTokenisationResponse](docs/CardTokenisationResponse.md)
 ...
 - [Citypay Api Client.FindPaymentIntentRequest](docs/FindPaymentIntentRequest.md)
 - [Citypay Api Client.HttpConfig](docs/HttpConfig.md)
 ...
 - [Citypay Api Client.MerchantBatchReportRequest](docs/MerchantBatchReportRequest.md)
 ...
 - [Citypay Api Client.PaymentIntentRequestModel](docs/PaymentIntentRequestModel.md)
 - [Citypay Api Client.PaymentIntentResponseModel](docs/PaymentIntentResponseModel.md)
 ...
 - [Citypay Api Client.RegisterIpModel](docs/RegisterIpModel.md)
 ...
 - [Citypay Api Client.TransactionReportRequest](docs/TransactionReportRequest.md)
 - [Citypay Api Client.VerificationRequest](docs/VerificationRequest.md)
 - [Citypay Api Client.VoidRequest](docs/VoidRequest.md)
 - [Citypay Api Client.WebHookChannelCreateRequest](docs/WebHookChannelCreateRequest.md)
 - [Citypay Api Client.WebHookChannelCreateResponse](docs/WebHookChannelCreateResponse.md)
 - [Citypay Api Client.WebHookChannelDeleteRequest](docs/WebHookChannelDeleteRequest.md)
 - [Citypay Api Client.WebHookSubscriptionRequest](docs/WebHookSubscriptionRequest.md)
 - [Citypay Api Client.WebHookSubscriptionResponse](docs/WebHookSubscriptionResponse.md)
 - [Citypay Api Client.WebHookUnsubscribeRequest](docs/WebHookUnsubscribeRequest.md)
