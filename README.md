# citypay-api-client-js

Citypay Api Client - JavaScript client for citypay-api-client-js
...
- Build date: 2020-09-16T13:36:18.565Z[GMT]
...
```shell
npm install citypay-api-client-js --save
```
...
To use the link you just defined in your project, switch to the directory you want to use your citypay-api-client-js from, and run:
