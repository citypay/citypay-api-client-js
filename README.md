...
- Build date: 2024-09-19T09:35:42.655154547Z[Etc/UTC]
...
var api = new Citypay Api Client.AuthorisationAndPaymentApi()
var auth_request = new Citypay Api Client.AuthRequest(); // {AuthRequest} 
api.authorisationRequest(auth_request).then(function(data) {
