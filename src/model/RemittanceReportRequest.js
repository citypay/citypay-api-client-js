...
/**
 * The RemittanceReportRequest model module.
 * @module model/RemittanceReportRequest
 */
class RemittanceReportRequest {
    /**
     * Constructs a new <code>RemittanceReportRequest</code>.
     * @alias module:model/RemittanceReportRequest
     */
    constructor() { 
        
        RemittanceReportRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RemittanceReportRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RemittanceReportRequest} obj Optional instance to populate.
     * @return {module:model/RemittanceReportRequest} The populated <code>RemittanceReportRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RemittanceReportRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>RemittanceReportRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RemittanceReportRequest</code>.
     */
 ...
 */
RemittanceReportRequest.prototype['date_from'] = undefined;

/**
 * End date (YYYY-MM-DD) for batch Retrieval range, inclusive.
 * @member {Date} date_until
 */
RemittanceReportRequest.prototype['date_until'] = undefined;
 ...
 */
RemittanceReportRequest.prototype['maxResults'] = undefined;

/**
 * @member {Array.<Number>} merchant_id
 */
RemittanceReportRequest.prototype['merchant_id'] = undefined;
 ...
 */
RemittanceReportRequest.prototype['nextToken'] = undefined;
 ...
 */
RemittanceReportRequest.prototype['orderBy'] = undefined;
...
export default RemittanceReportRequest;
