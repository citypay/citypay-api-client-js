...
/**
 * The BatchTransactionReportRequest model module.
 * @module model/BatchTransactionReportRequest
 */
class BatchTransactionReportRequest {
    /**
     * Constructs a new <code>BatchTransactionReportRequest</code>.
     * @alias module:model/BatchTransactionReportRequest
     */
    constructor() { 
        
        BatchTransactionReportRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchTransactionReportRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchTransactionReportRequest} obj Optional instance to populate.
     * @return {module:model/BatchTransactionReportRequest} The populated <code>BatchTransactionReportRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchTransactionReportRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchTransactionReportRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchTransactionReportRequest</code>.
     */
 ...
 */
BatchTransactionReportRequest.prototype['maxResults'] = undefined;
 ...
 */
BatchTransactionReportRequest.prototype['nextToken'] = undefined;
 ...
 */
BatchTransactionReportRequest.prototype['orderBy'] = undefined;
...
export default BatchTransactionReportRequest;
