...
class Error {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response_dt')) {
                obj['response_dt'] = ApiClient.convertToType(data['response_dt'], 'Date');
            }
        }
        return obj;
    }
 ...
 * @member {Date} response_dt
 */
Error.prototype['response_dt'] = undefined;
