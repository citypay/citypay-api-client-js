...
/**
 * The FindPaymentIntentRequest model module.
 * @module model/FindPaymentIntentRequest
 */
class FindPaymentIntentRequest {
    /**
     * Constructs a new <code>FindPaymentIntentRequest</code>.
     * @alias module:model/FindPaymentIntentRequest
     */
    constructor() { 
        
        FindPaymentIntentRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FindPaymentIntentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FindPaymentIntentRequest} obj Optional instance to populate.
     * @return {module:model/FindPaymentIntentRequest} The populated <code>FindPaymentIntentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FindPaymentIntentRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>FindPaymentIntentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FindPaymentIntentRequest</code>.
     */
 ...
 */
FindPaymentIntentRequest.prototype['external-ref'] = undefined;

/**
 * An external reference source to lookup.
 * @member {String} external-ref-source
 */
FindPaymentIntentRequest.prototype['external-ref-source'] = undefined;

/**
 * The merchant id the payment intent is registered for.
 * @member {Number} merchantid
 */
FindPaymentIntentRequest.prototype['merchantid'] = undefined;

/**
 * The payment intent id, if known.
 * @member {String} payment_intent_id
 */
FindPaymentIntentRequest.prototype['payment_intent_id'] = undefined;
...
export default FindPaymentIntentRequest;
