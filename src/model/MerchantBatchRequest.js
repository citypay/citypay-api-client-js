...
/**
 * The MerchantBatchRequest model module.
 * @module model/MerchantBatchRequest
 */
class MerchantBatchRequest {
    /**
     * Constructs a new <code>MerchantBatchRequest</code>.
     * @alias module:model/MerchantBatchRequest
     */
    constructor() { 
        
        MerchantBatchRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MerchantBatchRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MerchantBatchRequest} obj Optional instance to populate.
     * @return {module:model/MerchantBatchRequest} The populated <code>MerchantBatchRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MerchantBatchRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>MerchantBatchRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MerchantBatchRequest</code>.
     */
 ...
 */
MerchantBatchRequest.prototype['date_from'] = undefined;

/**
 * End date (YYYY-MM-DD) for batch retrieval range, inclusive.
 * @member {Date} date_until
 */
MerchantBatchRequest.prototype['date_until'] = undefined;
 ...
 */
MerchantBatchRequest.prototype['maxResults'] = undefined;

/**
 * @member {Array.<Number>} merchant_id
 */
MerchantBatchRequest.prototype['merchant_id'] = undefined;
 ...
 */
MerchantBatchRequest.prototype['nextToken'] = undefined;
 ...
 */
MerchantBatchRequest.prototype['orderBy'] = undefined;
...
export default MerchantBatchRequest;
